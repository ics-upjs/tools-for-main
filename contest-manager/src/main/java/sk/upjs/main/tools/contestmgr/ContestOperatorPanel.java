...
public class ContestOperatorPanel extends JPanel {
        ...
        contest.addContestListener(new Contest.ContestListener() {
            ...
            public void onContestChange() {
                ...
                if ((lastSaveFile != null)
                        && saveContinuouslyCheckBox.isEnabled()
    ...
    public void updateByContest() {
        ...
        winnerCombo.setModel(new DefaultComboBoxModel<String>(values
                .toArray(new String[0])));
        loserCombo.setModel(new DefaultComboBoxModel<String>(values
                .toArray(new String[0])));
    ...
    private void updateAddDuelResultButton() {
        btnAddDuel.setEnabled((winnerCombo.getSelectedIndex() >= 1)
                && (loserCombo.getSelectedIndex() >= 1)
                && (loserCombo.getSelectedIndex() != winnerCombo
                .getSelectedIndex()));
    }
    ...
    private void addDuelResultClicked() {
        contest.addDuel(
                contest.getContestant(winnerCombo.getSelectedIndex() - 1),
    ...
    private void saveContestResults(File dstFile) {
        try (PrintWriter pw = new PrintWriter(dstFile, "UTF-8")) {
            ...
            for (int i = 0; i < nCountestants; i++) {
                ...
                pw.println(c.getName() + "\t" + c.getRating());
            }
            pw.println("[Duels]");

            List<Contest.Duel> duels = contest.getDuels();
            for (Contest.Duel duel : duels) {
                pw.println(duel.winner.getName() + "\t" + duel.loser.getName()
                        + "\t" + duel.time);
            }
        } catch (Exception e) {
    ...
    private void loadContestResults(File srcFile) {
        ...
        try (Scanner scn = new Scanner(srcFile)) {
            // Nacitame mena ucastnikov
            while (scn.hasNextLine()) {
                ...
                try (Scanner lineScanner = new Scanner(line)) {
                    ...
                    String contestantName = lineScanner.next().trim();
                    ...
                    contest.getContestant(contest.getContestantsCount() - 1)
                            .setName(contestantName);
                }
            }
            ...
            while (scn.hasNext()) {
                String winnerName = scn.next();
                String looserName = scn.next();
                int time = scn.nextInt();
                contest.setTime(time);
                contest.addDuel(contest.getContestant(winnerName),
                        contest.getContestant(looserName));
            }
     ...
     */
    private void setSelectedContestant(String contestant,
    ...
    private void initComponents() {
        ...
        panel.setBorder(new TitledBorder(null, "Pridanie v\u00FDsledku duelu",
                TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));

        JPanel panel_1 = new JPanel();
        panel_1.setBorder(new TitledBorder(null, "Hist\u00F3ria duelov",
                TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
        ...
        groupLayout.setHorizontalGroup(groupLayout
                ...
                .addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 450,
                        Short.MAX_VALUE)
                .addComponent(panel, Alignment.TRAILING,
                        GroupLayout.DEFAULT_SIZE, 450, Short.MAX_VALUE)
                .addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 450,
                        Short.MAX_VALUE)
                .addComponent(panel_3, GroupLayout.DEFAULT_SIZE, 450,
                        Short.MAX_VALUE));
        groupLayout.setVerticalGroup(groupLayout.createParallelGroup(
                ...
                groupLayout
                        ...
                        .addComponent(panel, GroupLayout.PREFERRED_SIZE, 134,
                                GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(panel_1, GroupLayout.DEFAULT_SIZE, 95,
                                Short.MAX_VALUE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(panel_3, GroupLayout.PREFERRED_SIZE, 99,
                                GroupLayout.PREFERRED_SIZE)));
        ...
        saveButton.setIcon(new ImageIcon(ContestOperatorPanel.class
        ...
        statisticsButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                frame.setLocationRelativeTo(ContestOperatorPanel.this
                        .getRootPane().getParent());
            }
        });
        statisticsButton.setIcon(new ImageIcon(ContestOperatorPanel.class
        ...
        loadButton.setIcon(new ImageIcon(ContestOperatorPanel.class
        ...
        gl_panel_3.setVerticalGroup(gl_panel_3.createParallelGroup(
                ...
                .addGroup(
                        gl_panel_3
                                ...
                                .addPreferredGap(ComponentPlacement.RELATED)
                                .addComponent(saveContinuouslyCheckBox)
                                .addPreferredGap(ComponentPlacement.RELATED)
        ...
        playButton.setIcon(new ImageIcon(ContestOperatorPanel.class
        ...
        pauseButton.setIcon(new ImageIcon(ContestOperatorPanel.class
        ...
        stopButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                int dialogResult = JOptionPane.showConfirmDialog(
                        ContestOperatorPanel.this.getRootPane().getParent(),
        ...
        stopButton.setIcon(new ImageIcon(ContestOperatorPanel.class
        ...
        newWindowButton.setIcon(new ImageIcon(ContestOperatorPanel.class
                .getResource("/images/newWindow.png")));
                        ...
                        .addGroup(
                                gl_panel_1
                                        ...
                                        .addComponent(scrollPane,
                                                Alignment.TRAILING,
                                                GroupLayout.DEFAULT_SIZE, 325,
                                                Short.MAX_VALUE)
                                        .addComponent(btnRemoveLastDuel,
                                                Alignment.TRAILING))
                        .addContainerGap()));
        gl_panel_1.setVerticalGroup(gl_panel_1.createParallelGroup(
                ...
                gl_panel_1
                        ...
                        .addComponent(scrollPane, GroupLayout.DEFAULT_SIZE,
                                221, Short.MAX_VALUE)
                        .addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(btnRemoveLastDuel).addGap(5)));
        ...
        btnAddDuel.setIcon(new ImageIcon(ContestOperatorPanel.class
                .getResource("/images/write.png")));
        ...
        gl_panel.setVerticalGroup(gl_panel
                ...
                .addGroup(
                        ...
                        gl_panel.createSequentialGroup()
                                ...
                                .addGap(7).addComponent(btnAddDuel)
                                .addContainerGap()));
