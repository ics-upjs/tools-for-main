...
public class ContestTablePanel extends JPanel {
	...
	private class ContestResultsTableModel extends AbstractTableModel {
		...
		/**
		 * ID stlpca s menom sutaciaceho
		 */
		private static final int NAME_COLUMN = 0;

		/**
		 * ID stlpca s ratingom sutaciaceho
		 */
		private static final int RATING_COLUMN = 1;
	...
	private void updateContestInfo() {
		...
		if (duels.size() > 0) {
			...
			lastDuelLabel.setText(lastDuel.winner.getName() + " vs. " + lastDuel.loser.getName());
		} else {
	...
	private void changeTableFont(int change) {
		...
		table.setFont(currentFont.deriveFont(Math.max(5, currentFont.getSize2D() + change)));
		table.setRowHeight(Math.max(5, table.getRowHeight() + change));

		currentFont = timeLabel.getFont();
		timeLabel.setFont(currentFont.deriveFont(Math.max(5, currentFont.getSize2D() + change)));
	}
	...
	private void initComponents() {
		...
		btnNewButton.setIcon(new ImageIcon(ContestTablePanel.class.getResource("/images/font_increase.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(ContestTablePanel.class.getResource("/images/font_decrease.png")));
						...
						groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup().addContainerGap()
										.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
												.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 430,
														Short.MAX_VALUE)
												.addComponent(panel, GroupLayout.DEFAULT_SIZE, 430, Short.MAX_VALUE)
												.addGroup(groupLayout.createSequentialGroup().addComponent(timeLabel)
														.addPreferredGap(ComponentPlacement.RELATED, 274,
																Short.MAX_VALUE)
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(5)
						.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(timeLabel)
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap().addComponent(lblPoslednDuel)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(lastDuelLabel).addContainerGap(298,
								Short.MAX_VALUE)));
						...
						.addGroup(Alignment.TRAILING,
								gl_panel.createSequentialGroup()
										...
										.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblPoslednDuel).addComponent(lastDuelLabel))
										.addContainerGap()));
