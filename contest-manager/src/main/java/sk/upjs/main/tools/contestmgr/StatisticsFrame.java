...
public class StatisticsFrame extends JFrame {
    ...
    private class SuccessPanel extends JPanel {
        ...
        public void changeHistory(boolean[] winsInDuels) {
            ...
            int newWidth = this.winsInDuels.length
                    * Math.max(winImage.getWidth(), lossImage.getWidth());
            ...
            for (int i = 0; i < winsInDuels.length; i++) {
                if (winsInDuels[i]) {
                    g.drawImage(winImage,
                            i * slotWidth + (slotWidth - winImage.getWidth())
                                    / 2, 0, null);
                } else {
                    g.drawImage(lossImage, i * slotWidth
                                    + (slotWidth - lossImage.getWidth()) / 2,
                            winImage.getHeight(), null);
                }
            }
        }
    }
    ...
    public StatisticsFrame() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(
                StatisticsFrame.class.getResource("/images/statistics.png")));

        try {
            winImage = ImageIO.read(StatisticsFrame.class
                    .getResource("/images/happyFace.png"));
            lossImage = ImageIO.read(StatisticsFrame.class
                    .getResource("/images/sadFace.png"));
    ...
    public StatisticsFrame(Contest contest) {
        ...
        contestantComboBox.setModel(new DefaultComboBoxModel<String>(
                contestants.toArray(new String[0])));
    ...
    private void showGlobalStatistics() {
        ...
        if (contestants.size() == 0) {
            ...
            avgDuelPerContestantLabel.setText(Integer.toString((int) Math
                    .round(2 * duels.size() / (double) contestants.size())));
        }
        ...
        favouritePlayerLabel.setText(contestansToString(keysWithValue(duelsMap,
                Collections.max(duelsMap.values()))));
        unpopularContestantLabel.setText(contestansToString(keysWithValue(
                duelsMap, Collections.min(duelsMap.values()))));
        bestContestantLabel.setText(contestansToString(keysWithValue(winMap,
                Collections.max(winMap.values()))));
        worstContestantLabel.setText(contestansToString(keysWithValue(lossMap,
                Collections.max(lossMap.values()))));
    }
    ...
    private void updateIndividualStatistics() {
        ...
        duelsLabel.setText(Integer.toString(winCount + lossCount) + " ("
                + winCount + " výhier, " + lossCount + " prehier)");
        ...
        favAdversaryLabel.setText(contestansToString(keysWithValue(duelsMap,
                Collections.max(duelsMap.values()))));
        unpopAdversaryLabel.setText(contestansToString(keysWithValue(duelsMap,
                Collections.min(duelsMap.values()))));

        int max = Collections.max(winMap.values());
        if (max > 0) {
            bestAdversaryLabel.setText(contestansToString(keysWithValue(winMap,
                    max)));
        } else {
            bestAdversaryLabel.setText("-");
        }
        ...
        if (max > 0) {
            worstAdversaryLabel.setText(contestansToString(keysWithValue(
                    lossMap, max)));
        } else {
            worstAdversaryLabel.setText("-");
        }
    ...
    private void initComponents() {
        ...
        globalPanel.setBorder(new TitledBorder(null,
                "Celkov\u00E1 \u0161tatistika", TitledBorder.LEADING,
                TitledBorder.TOP, null, null));

        JPanel individualPanel = new JPanel();
        individualPanel.setBorder(new TitledBorder(null,
                "Individu\u00E1lna \u0161tatistika", TitledBorder.LEADING,
                TitledBorder.TOP, null, null));
        GroupLayout gl_contentPane = new GroupLayout(contentPane);
        gl_contentPane.setHorizontalGroup(gl_contentPane
                .createParallelGroup(Alignment.LEADING)
                .addComponent(globalPanel, GroupLayout.DEFAULT_SIZE, 424,
                        Short.MAX_VALUE)
                .addComponent(individualPanel, GroupLayout.DEFAULT_SIZE, 395,
                        Short.MAX_VALUE));
        ...
        gl_individualPanel
                .setHorizontalGroup(gl_individualPanel
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(
                                Alignment.TRAILING,
                                gl_individualPanel
                                        ...
                                        .addContainerGap()));
        gl_individualPanel
                .setVerticalGroup(gl_individualPanel
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(
                                gl_individualPanel
                                        .createSequentialGroup()
        ...
        JLabel lblPriemernPoetDuelov = new JLabel(
                "Priemerný počet duelov hráča:");
        ...
        gl_globalPanel
                .setHorizontalGroup(gl_globalPanel
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(
                                gl_globalPanel
                                        .createSequentialGroup()
                                                                        ...
                                                                        .addGroup(
                                                                                gl_globalPanel
                                                                                        ...
                                                                                        .addComponent(
                                                                                                ...
                                                                                                Short.MAX_VALUE)
                                                                                        .addComponent(
                                                                                                worstContestantLabel,
                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                233,
                                                                                                Short.MAX_VALUE))))
                                        .addContainerGap()));
        gl_globalPanel
                .setVerticalGroup(gl_globalPanel
                        .createParallelGroup(Alignment.LEADING)
                        .addGroup(
                                gl_globalPanel
                                        .createSequentialGroup()
